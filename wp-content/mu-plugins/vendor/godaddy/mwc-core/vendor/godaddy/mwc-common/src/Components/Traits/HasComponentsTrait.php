...
trait HasComponentsTrait
{
    ...
    {
        if (! property_exists($this, 'componentClasses')) { // @phpstan-ignore function.alreadyNarrowedType
        ...
        return TypeHelper::arrayOfClassStrings(ArrayHelper::wrap($this->componentClasses), ComponentContract::class, false);
    }
    ...
    {
        /** @throws ComponentClassesNotDefinedException|ComponentLoadFailedException */
        return TypeHelper::arrayOf(array_map([static::class, 'maybeLoadComponent'], $this->getComponentClasses()), ComponentContract::class, false);
    }
    ...
    public static function maybeInstantiateComponent(string $className)
    {
        ...
        try {
            ...
            SentryException::getNewInstance("Could not instantiate component {$className}.", $exception);
