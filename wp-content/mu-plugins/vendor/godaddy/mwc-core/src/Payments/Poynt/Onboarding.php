...
class Onboarding
{
    ...
    protected static function hasEnabledPaymentGateways() : bool
    {
        ...
        // intentionally scans registered gateways rather than WC()->payment_gateways()->get_available_payment_gateways(),
        // which depends on a front-end WC session and is unreliable in the admin/REST/cron contexts this runs in
