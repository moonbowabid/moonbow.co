...
class InsertResourceTypesAction implements ConditionalComponentContract
{
    ...
    protected function run() : void
    {
        $resourceTypes = [
            ...
            CommerceResourceTypes::Location,
            CommerceResourceTypes::InventoryAdjustment,
            CommerceResourceTypes::ListTree,
            CommerceResourceTypes::ListTreeNode,
        ];
